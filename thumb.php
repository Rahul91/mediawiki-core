...
function wfStreamThumb( array $params ) {
	...
	$fileName = isset( $params['f'] ) ? $params['f'] : '';
        ...
        if( $fileName == null && $width == null ){
              wfThumbError( 1 , 'Parametes are missing, thumb.php takes 3 parameter, f for filename, w for width, p for pages, if available, none given. Also The requested page title was invalid, empty, or an incorrectly linked inter-language or inter-wiki title. It may contain one or more characters that cannot be used in titles.' );
              return;
        }
